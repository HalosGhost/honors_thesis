...
\begin{center}
\begin{tabu} {c|c|c|}
   \multicolumn{1}{c}{} & \multicolumn{1}{c}{Inquisitive} & \multicolumn{1}{c}{Rhetorical}\\\cline{2-3}
   Narrow Scope & Interrogative & Innocuous\\\cline{2-3}
   Wide Scope & Assertive & Objecting\\\cline{2-3}
\end{tabu}
\end{center}
